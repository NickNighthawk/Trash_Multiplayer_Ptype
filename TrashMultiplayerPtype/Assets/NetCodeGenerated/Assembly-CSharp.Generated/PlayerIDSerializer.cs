...
{
    [BurstCompile]
    public struct PlayerIDGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<PlayerID>(),
                    ComponentSize = UnsafeUtility.SizeOf<PlayerID>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<PlayerID>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<PlayerID>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<PlayerID>(backupData, 0);

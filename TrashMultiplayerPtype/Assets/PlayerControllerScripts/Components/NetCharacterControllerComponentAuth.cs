...
using UnityEngine;
    ...
    /// </summary>
    public struct NetCharacterControllerComponent : IComponentData
    {
        // -------------------------------------------------------------------------------------
        // Current Movement
        // -------------------------------------------------------------------------------------
        ...
        /// <summary>
        /// Is the character requesting to crouch?
        /// Used in conjunction with <see cref="IsCrouched"/> to determine if the <see cref="CrouchStrength"/> should be used to make the entity fall.
        /// </summary>
        ...
        /// <summary>
        /// The normal speed at which the player moves.
        /// </summary>
        ...
        /// <summary>
        /// The strength which controls how fast the player will descend without gravity.
        /// </summary>
        public float CrouchStrength { get; set; }
    ...
    /// </summary>
    [Serializable]
    public sealed class NetCharacterControllerComponentAuth : MonoBehaviour, IConvertGameObjectToEntity
    {
        ...
        public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
        {
            ...
            dstManager.AddComponentData(entity, new NetCharacterControllerComponent()
            {
                Gravity = Gravity,
                MaxSpeed = MaxSpeed,
                Speed = Speed,

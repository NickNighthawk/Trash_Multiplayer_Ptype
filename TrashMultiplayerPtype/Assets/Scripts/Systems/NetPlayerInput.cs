...
public struct NetPlayerInput : ICommandData
{
...
public class NetSamplePlayerInputSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        if (localInput == Entity.Null)
        {
            ...
            Entities.WithAll<NetMovementComponent>().WithNone<NetPlayerInput>().ForEach((Entity ent, ref GhostOwnerComponent ghostOwner) =>
            {
                if (ghostOwner.NetworkId == localPlayerId)
                {
                    commandBuffer.AddBuffer<NetPlayerInput>(ent);
        ...
        var input = default(NetPlayerInput);
        ...
        var inputBuffer = EntityManager.GetBuffer<NetPlayerInput>(localInput);
